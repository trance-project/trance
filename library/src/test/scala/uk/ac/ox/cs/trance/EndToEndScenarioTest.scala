...
//          IfThenElse(d("lName") === "Java") (RepRow("inner" -> d("nested"))) (RepRow.empty)
//        })
//      })}.leaveNRC()
//
//      oquery.show(false)
...
//    }
//
//    it("Test for a nesting arrays after leaveNRC") {
//      val df1 = simpleIntDataframe.wrap()
//      val df2 = simpleIntDataframe2.wrap()
//
//      val res1 = df1.map{f =>
//        RepRow("unnestedField" -> df2.map{z =>
//          RepSeq(RepRow(z("usr")))
//        })
//      }
//
//
////      val res2 = res1.map { t =>
////        RepRow("unnestedLng" -> t("unnestedField").flatMap { o =>
////          o("usr")
////        })
////      }.leaveNRC()
//
//
//      // TODO allow unnesting like below
//      val res2 = res1.flatMap(f => f("unnestedField").flatMap(o => RepSeq(RepRow(o("usr"))))).leaveNRC()
//
//      res2.show(false)
//      res2.printSchema()
//
//    }
//
//    it("Unnesting an arraytype") {
//      val arrayDf = arrayTypeDataframe2
//
//
//        val wrappedDf = arrayDf.wrap()
//
//      val res1 = wrappedDf.map { f =>
//        RepRow(f("name"), "renestedLanguage" -> f("languageClass").flatMap(z => RepSeq(RepRow(z("language")))))
//      }.leaveNRC()
//
//      arrayDf.show(false)
//      arrayDf.printSchema()
...
//      res1.printSchema()
//
//      assertDataFramesAreEquivalent(arrayDf, res1)
//
//    }
