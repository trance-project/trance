...
val x655 = x634.map{
  case (a, null) => (a, 0.0)
  case ((x637, x638), x639) => ((x637, x637._2.c_name, x638.o_orderdate, x639.p_name), x639.l_qty)
}.reduceByKey(_+_)
  x655.count
   }
   f
   var end0 = System.currentTimeMillis() - start0
   println("ShredQuery4SparkOpt"+sf+","+Config.datapath+","+end0)
 }
}
