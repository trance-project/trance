...
object App {
  ...
  def runExperiment2FN(){
    ...
    Utils.flatOpt(Test0, pathout, "Flat++,Standard")
    Utils.flatOpt(Test0, pathout, "Flat++,Skew", skew = true)
    Utils.flatOpt(Test1, pathout, "Flat++,Standard")
    Utils.flatOpt(Test1, pathout, "Flat++,Skew", skew = true)
    Utils.flatOpt(Test2Flat, pathout, "Flat++,Standard")
    Utils.flatOpt(Test2Flat, pathout, "Flat++,Skew", skew = true)
    Utils.flatOpt(Test3Flat, pathout, "Flat++,Stanard")
    Utils.flatOpt(Test3Flat, pathout, "Flat++,Skew", skew = true)
    Utils.flatOpt(Test4Flat, pathout, "Flat++,Standard")
    Utils.flatOpt(Test4Flat, pathout, "Flat++,Skew", skew = true)

    Utils.shred(Test0, pathout, "Shred,Standard")
    Utils.shred(Test1, pathout, "Shred,Standard")
    Utils.shred(Test2, pathout, "Shred,Standard")
    Utils.shred(Test3, pathout, "Shred,Standard")
    Utils.shred(Test4, pathout, "Shred,Standard")

    Utils.shred(Test0, pathout, "Shred,Skew", skew = true)
    Utils.shred(Test1, pathout, "Shred,Skew", skew = true)
    Utils.shred(Test2, pathout, "Shred,Skew", skew = true)
    Utils.shred(Test3, pathout, "Shred,Skew", skew = true)
    Utils.shred(Test4, pathout, "Shred,Skew", skew = true)

    Utils.shred(Test0, pathout, "Shred,Standard", unshred=true)
    Utils.shred(Test1, pathout, "Shred,Standard", unshred=true)
    Utils.shred(Test2, pathout, "Shred,Standard", unshred=true)
    Utils.shred(Test3, pathout, "Shred,Standard", unshred=true)
    Utils.shred(Test4, pathout, "Shred,Standard", unshred=true)

    Utils.shred(Test0, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shred(Test1, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shred(Test2, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shred(Test3, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shred(Test4, pathout, "Shred,Skew", unshred=true, skew = true)
  ...
  def runExperiment2NN(){
    ...
    Utils.flatOptInput(Test0, Test0NN, pathout, "Flat++,Standard")
    Utils.flatOptInput(Test1, Test1NN, pathout, "Flat++,Standard")
    Utils.flatOptInput(Test2Flat, Test2NN, pathout, "Flat++,Standard")
    Utils.flatOptInput(Test3Flat, Test3NN, pathout, "Flat++,Standard")
    Utils.flatOptInput(Test4Flat, Test4NN, pathout, "Flat++,Standard")

    Utils.flatOptInput(Test0, Test0NN, pathout, "Flat++,Skew", skew = true)
    Utils.flatOptInput(Test1, Test1NN, pathout, "Flat++,Skew", skew = true)
    Utils.flatOptInput(Test2Flat, Test2NN, pathout, "Flat++,Skew", skew = true)
    Utils.flatOptInput(Test3Flat, Test3NN, pathout, "Flat++,Skew", skew = true)
    Utils.flatOptInput(Test4Flat, Test4NN, pathout, "Flat++,Skew", skew = true)

    Utils.shredInput(Test0, Test0NN, pathout, "Shred,Standard")
    Utils.shredInput(Test1, Test1NN, pathout, "Shred,Standard")
    Utils.shredInput(Test2, Test2NN, pathout, "Shred,Standard")
    Utils.shredInput(Test3, Test3NN, pathout, "Shred,Standard")
    Utils.shredInput(Test4, Test4NN, pathout, "Shred,Standard")

    Utils.shredInput(Test0, Test0NN, pathout, "Shred,Standard", unshred=true)
    Utils.shredInput(Test1, Test1NN, pathout, "Shred,Standard", unshred=true)
    Utils.shredInput(Test2, Test2NN, pathout, "Shred,Standard", unshred=true)
    Utils.shredInput(Test3, Test3NN, pathout, "Shred,Standard", unshred=true)
    Utils.shredInput(Test4, Test4NN, pathout, "Shred,Standard", unshred=true)

    Utils.shredInput(Test0, Test0NN, pathout, "Shred,Skew", skew = true)
    Utils.shredInput(Test1, Test1NN, pathout, "Shred,Skew", skew = true)
    Utils.shredInput(Test2, Test2NN, pathout, "Shred,Skew", skew = true)
    Utils.shredInput(Test3, Test3NN, pathout, "Shred,Skew", skew = true)
    Utils.shredInput(Test4, Test4NN, pathout, "Shred,Skew", skew = true)

    Utils.shredInput(Test0, Test0NN, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shredInput(Test1, Test1NN, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shredInput(Test2, Test2NN, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shredInput(Test3, Test3NN, pathout, "Shred,Skew", unshred=true, skew = true)
    Utils.shredInput(Test4, Test4NN, pathout, "Shred,Skew", unshred=true, skew = true)
  }
