...
const ShreddedCompilationView = (props:_MaterializationProps) => {
            ...
            <Accordion className={classes.accordion2lvl} defaultExpanded>
                ...
                <AccordionDetails>
                    <Typography className={classes.body} component={'div'}>
                        ...
                        <Typography style={{textIndent: '50px'}}>{'{'}(mutId := o<S variant={"accent"}>F</S>.mutId, score:= NewLabel(o<S variant={"accent"}>F</S>.sample,o<S variant={"accent"}>F</S>.mutations)){'}'}</Typography>
                        <Accordion className={classes.accordionWhite}>
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon />}
                                aria-controls="panel2a-content"
...
export default ShreddedCompilationView