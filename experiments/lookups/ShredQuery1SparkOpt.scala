...
var start0 = System.currentTimeMillis()
 val x134 = L__D_1
val x139 = P__D_1
val x141 = x134.map{ case x140 => ({val x142 = x140.l_partkey 
x142}, x140) }
val x144 = x141.joinSkew(x139, (p:PartProj4) => p.p_partkey)
...
val result = top.cogroup(x207).flatMap{
  case (_, (names, dates)) => names.map(n => (n, dates))
}
