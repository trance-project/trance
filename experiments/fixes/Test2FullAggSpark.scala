...
case class Recordb8484513eaed470d947b7c67ca2d438c(c_acctbal: Double, c_name: String, c_nationkey: Int, c_custkey: Int, c_comment: String, c_address: String, c_orders: Seq[Record597f65dcd7dc4785975c7d4f56645da6], c_mktsegment: String, c_phone: String)
case class Record661b36b58e3640a89de49309079847d3(c_acctbal: Double, c_name: String, o_parts: Option[Seq[Recorddba06c3f790c4c5a873e3cbdff7bed13]], c_nationkey: Int, c_custkey: Int, c_comment: String, c_address: String, c_mktsegment: String, c_phone: String)
case class Record1e82904b718e4be7896aa7b2d4d81a7d(c_acctbal: Double, l_quantity: Option[Double], c_name: String, c_nationkey: Int, l_partkey: Option[Int], c_custkey: Int, c_comment: String, c_address: String, c_mktsegment: String, c_phone: String)
case class Record076fd338f4244cc1a2640803edf70c39(p_retailprice: Double, p_partkey: Int)
case class Record1cd22b16a2e84a8d8d045aa2880a0006(c_acctbal: Double, l_quantity: Option[Double], p_retailprice: Option[Double], c_name: String, c_nationkey: Int, l_partkey: Option[Int], p_partkey: Option[Int], c_custkey: Int, c_comment: String, c_address: String, c_mktsegment: String, c_phone: String)
case class Recorde9c0a56e3f9f4a508b59fb0281cddbbd(p_name: Option[String], total: Option[Double])
case class Record88e622bbb1544121b281c47b53140dd4(c_acctbal: Double, c_name: String, c_nationkey: Int, c_custkey: Int, c_comment: String, c_address: String, c_mktsegment: String, c_phone: String)
case class Record9bf4771e2f404968bdb00523065721f4(c_acctbal: Double, c_name: String, c_nationkey: Int, c_custkey: Int, c_comment: String, c_address: String, c_mktsegment: String, c_phone: String)
...
val x182 = x179//.withColumn("index", monotonically_increasing_id())
 .as[Recordb8484513eaed470d947b7c67ca2d438c].flatMap{
   case x205 => if (x205.c_orders.isEmpty) Seq(Record661b36b58e3640a89de49309079847d3(x205.c_acctbal, x205.c_name, None, x205.c_nationkey, x205.c_custkey, x205.c_comment, x205.c_address, x205.c_mktsegment, x205.c_phone)) 
     else x205.c_orders.map( x206 => Record661b36b58e3640a89de49309079847d3(x205.c_acctbal, x205.c_name, Some(x206.o_parts), x205.c_nationkey, x205.c_custkey, x205.c_comment, x205.c_address, x205.c_mktsegment, x205.c_phone) )
...
val x186 = x182//.withColumn("index", monotonically_increasing_id())
 .as[Record661b36b58e3640a89de49309079847d3].flatMap{
   case x207 => x207.o_parts match {
     case None => Seq(Record1e82904b718e4be7896aa7b2d4d81a7d(x207.c_acctbal, None, x207.c_name, x207.c_nationkey, None, x207.c_custkey, x207.c_comment, x207.c_address, x207.c_mktsegment, x207.c_phone))
     case Some(bag) if bag.isEmpty => Seq(Record1e82904b718e4be7896aa7b2d4d81a7d(x207.c_acctbal, None, x207.c_name, x207.c_nationkey, None, x207.c_custkey, x207.c_comment, x207.c_address, x207.c_mktsegment, x207.c_phone))
     case Some(bag) => bag.map( x208 => Record1e82904b718e4be7896aa7b2d4d81a7d(x207.c_acctbal, Some(x208.l_quantity), x207.c_name, x207.c_nationkey, Some(x208.l_partkey), x207.c_custkey, x207.c_comment, x207.c_address, x207.c_mktsegment, x207.c_phone) )
...
val x200 = x193.reduceByKey(x209 => 
 Record88e622bbb1544121b281c47b53140dd4(x209.c_acctbal, x209.c_name, x209.c_nationkey, x209.c_custkey, x209.c_comment, x209.c_address, x209.c_mktsegment, x209.c_phone), x => x.p_retailprice match {
