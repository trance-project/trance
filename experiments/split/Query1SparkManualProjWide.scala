...
case class RecordLP(p: Part, l_qty: Double)
...
object Query1SparkManualProjWide {
  def main(args: Array[String]){
    ...
    val colp = col.leftOuterJoin(parts).map{
      case (pk, (((c,o), l), Some(p))) => (c, o) -> RecordLP(p._1, l._1.l_quantity)
      case (pk, (((c,o), null), None)) => (c, o) -> RecordLP(null, 0.0)
      case (pk, (((c,o), l), None)) => (c, o) -> RecordLP(null, l._1.l_quantity)
    }.aggregateByKey(List.empty[RecordLP])(accum3, accum4).map{
      case ((c,null), parts) => c -> RecordOLP(null, parts)
      case ((c,o), parts) => c -> RecordOLP(o._1, parts)
