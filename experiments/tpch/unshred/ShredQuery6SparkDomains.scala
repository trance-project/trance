...
println("ShredQuery6SparkDomains"+sf+","+Config.datapath+","+end0+",query,"+spark.sparkContext.applicationId)
...
var end = System.currentTimeMillis() - start
   println("ShredQuery6SparkDomains"+sf+","+Config.datapath+","+end+",total,"+spark.sparkContext.applicationId)
 }
}
