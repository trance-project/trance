...
val x277 = x267.flatMap{ case (x269, x268) => val x276 = (x269) 
x276 match {
   case (null) => Nil 
...
val x315 = x306.flatMap{ case (x308, x307) => val x314 = (x308) 
x314 match {
   case (null) => Nil 
...
val x403 = x392.flatMap{ case (x395, (x393, x394)) => val x402 = (x393,x394,x395) 
x402 match {
   case (_,null,_) => Nil
case (_,_,null) => Nil
