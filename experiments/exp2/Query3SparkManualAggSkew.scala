...
object Query3SparkManualAggSkew {
  def main(args: Array[String]){
    val sf = Config.datapath.split("/").last
    val conf = new SparkConf().setMaster(Config.master).setAppName("Query3SparkManualAggSkew"+sf)
    ...
    var end0 = System.currentTimeMillis() - start0
	  println("Query3SparkManualAggSkew"+sf+","+Config.datapath+","+end0+",query,"+spark.sparkContext.applicationId)
