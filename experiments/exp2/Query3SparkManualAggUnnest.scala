...
object Query3SparkManualAggUnnest {
  def main(args: Array[String]){
    val sf = Config.datapath.split("/").last
    val conf = new SparkConf().setMaster(Config.master).setAppName("Query3SparkManualAggUnnest"+sf)
    ...
    var end0 = System.currentTimeMillis() - start0
	  println("Query3SparkManualAggUnnest"+sf+","+Config.datapath+","+end0+",query,"+spark.sparkContext.applicationId)
