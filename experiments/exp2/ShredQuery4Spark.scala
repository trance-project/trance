...
val c_orders__D_1s = query1__D_2c_orders_1.lookup(c_orders_ctx1, (l: Int) => l)

val o_parts_ctx1 = c_orders__D_1.createDomain(l => l.o_parts)


val x277 = query1__D_2c_orders_2o_parts_1.lookup(o_parts_ctx1, (l: Int) => l)

val x223 = x277.mapPartitions( it =>
